...
"""
    ...
    if ctype == "long":
        narration_blocks = [
            ...
            ("00:03.0", "00:05.0", f"{title_short},"),
            ("00:05.0", "00:08.0", f"{goal_summary} 배울 수 있는 과정입니다."),
            ("00:08.0", "00:10.0", benefit_line.replace(" 💰", "") + "."),
            ("00:10.0", "00:12.0", "내일배움카드 있으면 누구나 신청 가능합니다."),
            ("00:12.0", "00:15.0", cta_text.replace(" 🔥", "").replace(" 👆", "") + " 지금 바로 신청하세요."),
        ]
    elif ctype == "short":
        narration_blocks = [
            ("00:00.0", "00:02.0", hook),
            ("00:02.0", "00:04.5", f"{title_short},"),
            ("00:04.5", "00:07.0", f"{goal_summary} 한 번에 배워보세요."),
            ("00:07.0", "00:09.5", benefit_line.replace(" 💰", "") + "."),
            ("00:09.5", "00:11.0", "내일배움카드만 있으면 신청 가능합니다."),
            ("00:11.0", "00:15.0", cta_text.replace(" 🔥", "").replace(" 👆", "") + " 놓치지 마세요."),
        ]
    else:
        narration_blocks = [
            ("00:00.0", "00:03.0", hook),
            ("00:03.0", "00:05.5", f"{title_short},"),
            ("00:05.5", "00:08.0", f"{goal_summary} 실무까지 배울 수 있습니다."),
            ("00:08.0", "00:10.0", benefit_line.replace(" 💰", "") + "."),
            ("00:10.0", "00:12.0", "내일배움카드 있으면 누구나 신청 가능합니다."),
            ("00:12.0", "00:15.0", cta_text.replace(" 🔥", "").replace(" 👆", "") + " 지금 바로 신청하세요."),
        ]
